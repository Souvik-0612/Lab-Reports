...
$\mathrm{DR}_0$ & is the dose output rate at 1 m, in $\mathrm{Gy}\cdot\mathrm{h}^{-1}$.
\end{tabular}
\\
$W = 1.5 \times 10^5 \, \mathrm{cGy/week} $ and $DR_0 = 82.38cGy/min\times ( 80/100)^2 = 52.7232$

Using Equation \ref{TADR}, the weekly time averaged dose-equivalent rate is,
