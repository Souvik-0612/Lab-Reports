...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{/Users/souvikdas/Desktop/Lab-Reports/4th Sem/PDD and Profile/Program/PDD_6MV.pdf}
    \caption{PDD profile of 6MV SSD=100, Water Phantom, F.S= 10x10cm$^2$}
\end{figure}