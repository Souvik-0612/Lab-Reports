...
SPD = 0 # surface PD
dmax = 0; x90 = 0; x50 = 0; PDD90 = 0; PDD50 = 0
...
plt.title(r"PDD profile of 6MV FFF SSD=100, Water Phantom, F.S= 10x10cm$^2$", fontsize=20)
plt.plot(x, PDD)
...
plt.savefig("Figures/PDD/PDD_6MVFFFPhoton.pdf", format='pdf') 
plt.show()