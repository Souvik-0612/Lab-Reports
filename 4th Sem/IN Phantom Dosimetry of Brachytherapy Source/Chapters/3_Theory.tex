...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{/Users/souvik/Desktop/Lab-Reports/4th Sem/IN Phantom Dosimetry of Brachytherapy Source/Figures/Theory/TG43 Image.png}
\caption{Schematic representation of the cylindrical coordinate system used in TG-43 dosimetry calculations. The source is located at the origin, with the active core aligned along the z-axis. The point of interest $P(r, \theta)$ is defined by its radial distance $r$ and polar angle $\theta$. The reference point $P(r_0, \theta_0)$ is located at $r_0 = 1$ cm and $\theta_0 = 90^\circ$.}
\label{Source}
\end{figure}
...
For a line source centered at the origin, let $\theta_1$ and $\theta_2$ be the angles subtended by the two ends of the active length at the point $P(r,\theta)$. Then,
\begin{equation}
    \beta = \theta_2 - \theta_1
\end{equation}
where
\begin{equation}
    \tan \theta_2 = \frac{r \sin\theta}{r \cos\theta - L/2}
\end{equation}
\begin{equation}
    \tan \theta_1 = \frac{r \sin\theta}{r \cos\theta + L/2}
\end{equation}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{\detokenize{Figures/Theory/INPhantamExp.jpg}}
\caption{Experimental setup used for in-phantom dosimetry measurements.}
\label{fig:inphantom-setup}
\end{figure}

\subsection{MicroSelectron HDR System Specifications}
Table~\ref{tab:microselectron-specs} summarizes key technical specifications of the Elekta microSelectron platform and its commonly used $^{192}$Ir source model.

\begin{table}[H]
\centering
\caption{Selected specifications of Elekta microSelectron HDR system}
\label{tab:microselectron-specs}
\begin{tabular}{|p{0.42\textwidth}|p{0.5\textwidth}|}
\hline
\textbf{Specification} & \textbf{Value} \\
\hline
System type & Remote afterloading brachytherapy platform (HDR/PDR configurable) \\
\hline
Dwell step options & 2.5 mm, 5 mm, or 10 mm \\
\hline
Source positioning accuracy & $\pm 1$ mm at each dwell position \\
\hline
Available treatment channel configurations & 6, 18, or 30 channels \\
\hline
Source active core dimensions ($^{192}$Ir mHDR-v2) & Length: 3.60 mm; diameter: 0.65 mm \\
\hline
Encapsulation dimensions/material & 0.90 mm outer diameter, AISI 316L stainless steel capsule \\
\hline
\end{tabular}
\end{table}

These values are compiled from Elekta microSelectron product documentation and CLRP source-model data \cite{elekta_microselectron_brochure,clrp_microselectron_v2}.

\begin{figure}[H]
\centering
\begin{minipage}[t]{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{\detokenize{Figures/Theory/OldSource.png}}
\end{minipage}\hfill
\begin{minipage}[t]{0.48\textwidth}
\centering
\includegraphics[width=\textwidth]{\detokenize{Figures/Theory/NewSource.png}}
\end{minipage}
\caption{MicroSelectron HDR 192Ir source type designs (Nucletron B.V ., Veenendaal, The Netherlands). (a) The old ``classic'' design with 0.6 mm cylindrical core diameter and 3.5 mm core length having a total outer diameter (including encapsulation) of 1.1 mm.20 (b) The new design with a cylindrical core diameter of 0.65 mm and core length of 3.6 mm. The total outer diameter of this source design is 0.9 mm (figure provided by Nucletron). All dimensions shown are in mm.}
\label{fig:microselectron-source-designs}
\end{figure}
